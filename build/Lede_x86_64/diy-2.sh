...
sed -i "/uci commit fstab/i\uci set network.lan.ipaddr='192.168.2.2'" $ZZZ
sed -i "/uci commit fstab/i\uci set network.lan.netmask='255.255.255.0'" $ZZZ
sed -i "/uci commit fstab/i\uci set network.lan.gateway='192.168.2.1'" $ZZZ
sed -i "/uci commit fstab/i\uci set network.lan.broadcast='192.168.2.255'" $ZZZ
sed -i "/uci commit fstab/i\uci set network.lan.dns='223.5.5.5 114.114.114.114'" $ZZZ
sed -i "/uci commit fstab/i\uci set network.lan.delegate='0'" $ZZZ
